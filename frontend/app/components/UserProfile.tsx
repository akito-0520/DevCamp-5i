...
export function UserProfile({ userId, onClose }: UserProfileProps) {
  ...
  const handleSave = () => {
    updateUser(userId, {
      ...
      schoolDepartment: editData.schoolDepartment,
      discordAccount: editData.discordAccount,
    });
    setIsEditing(false);
  };
              ...
              {isEditing ? (
                <div className="space-y-2">
                  <input
                    ...
                    placeholder="ニックネーム"
                    className="text-xl font-semibold bg-gray-100 dark:bg-gray-800 rounded px-2 py-1 w-full"
                  />
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="名"
                      className="bg-gray-100 dark:bg-gray-800 rounded px-2 py-1 flex-1"
                    />
                    <input
                      type="text"
          ...
          <div className="space-y-3">
            <div>
              ...
              {isEditing ? (
                <input
                  type="text"
                  value={editData.discordAccount}
                  onChange={(e) =>
                    setEditData({ ...editData, discordAccount: e.target.value })
                  }
              ...
              {isEditing ? (
                <select
                  ...
                  onChange={(e) =>
                    setEditData({
                      ...editData,
                      schoolYear: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded"
                >
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  type="text"
                  value={editData.schoolDepartment}
                  onChange={(e) =>
                    setEditData({
                      ...editData,
                      schoolDepartment: e.target.value,
                    })
                  }
                  className="w-full px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded"
                />
